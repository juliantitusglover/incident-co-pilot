...
def test_incident_report_markdown_response_includes_request_id(client_fixture):
    create_response = client_fixture.post(
        "/api/v1/incidents",
        json={
            "title": "Request ID Markdown Report",
            "description": "Incident used for Markdown report request ID test",
            "status": "open",
            "severity": "sev2",
        },
    )
