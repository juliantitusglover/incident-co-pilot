...
Incident Co-Pilot 0.4.x is a lightweight, local/self-hosted incident timeline API. This policy describes how to report security issues and the current security expectations for this early version.
